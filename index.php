...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
    try{
        ...
        if($query_run)
        {
            header('location:./php_todo_app/login.php');
        }else
        {
    ...
    <div class="conatiner">
       <div class="col-sm-4 col-sm-4"></div>
        <div class="col-sm-4 col-sm-4">
           <form  action=""method="POST" style="margin-top:105px">
            <div class="row">
                <div class="col-sm-6"><button class="btn btn-info btn-block"><i class="fa fa-facebook fa-lg" aria-hidden="true"></i></button></div>
                <div class="col-sm-6"><button class="btn btn-danger btn-block" onclick = "window.location='<?php echo $loginurl ?>';"><i class="fa fa-google fa-lg" aria-hidden="true"></i></button></div>
            </div>
                ...
                <p style="color:black">if you have already register : <a href="./php_todo_app/login.php">click here to login</a></p>
           </form>
           <?php if($error){
